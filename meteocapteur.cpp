     ...
     //   bus = "//dev//i2c-1";
      ...
      //  float fTemp = cTemp * 1.8 + 32;
       ...
       // float pressure = (p + (var1 + var2 + ((float)dig_P7)) / 16.0) / 100;
        this->pressure=(p + (var1 + var2 + ((float)dig_P7)) / 16.0) / 100;
...
float MeteoCapteur::getFTemp()
{
    return this->fTemp;
}

float MeteoCapteur::getPressure()
{
    return this->pressure;
}

float MeteoCapteur::getHumidity()
{
